...
## EXTENSION A VSCODE: PHP Intelephense
    ...
    POUR NOUS AIDER A CODER EN PHP...
    AJOUTER CETTE EXTENSION DANS VSCODE
...
```php
        ...
        <!-- en php avec variable -->
        <?php $h1 = "Mon Site Vitrine" ?>
        <h1><?php echo $h1 ?></h1>

        <!-- en php avec variable dans un autre fichier php -->
        <?php $h1 = "Mon Site Vitrine" ?>
        ...
...
## require_once
    ...
    ET ENSUITE UTILISER CETTE VARIABLE DANS UN AUTRE FICHIER CHARGE APRES AVEC require_once
