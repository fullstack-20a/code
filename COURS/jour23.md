...
## EXERCICE: AVANCER SUR LES MAQUETTES DU PROJET...

## PROJET AVEC GIT ET SYMFONY

    UNE PERSONNE DANS L'EQUIPE VA INSTALLER LE PROJET SYMFONY
    ENSUITE ELLE VA AJOUTER LE REPO GIT SUR LE PROJET
    ENSUITE ELLE VA PUSHER LE CODE DANS LE REPO GITHUB

    A PARTIR DE LA, LES AUTRES MEMBRES VONT RECUPERER LE REPO GITHUB AVEC UN GIT CLONE
    => MALHEUREUSEMENT, POUR ECONOMISER DU STOCKAGE SYMFONY NE MET PAS TOUT LE CODE NECESSAIRE DANS GIT
    => LE GIT CLONE DONNE UN SYMFONY INCOMPLET
